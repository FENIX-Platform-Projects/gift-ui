define(function () {
    ...
    return {
        ...
        downloadDataJustificationError: "Please, insert a valid justification before saving",
        ...
        metadataSaveError: "Please insert the mandatory fields in the following sections:",
        mdeMenu_longTitle: 'Metadata Menu',
        mdeMenu_shortTitle: 'MM',
        mdeMenu_toggleMenu: 'Toggle Menu',
        mdeMenu_save: 'Save',
        mdeMenu_cancel: 'Cancel',
        mdeMenu_close: 'Close',
        mdeMenu_form0: 'Administrator',
        mdeMenu_form1: 'General Information',
        mdeMenu_form1_0: 'Geographical/administrative coverage',
        mdeMenu_form1_1: 'Contact person(s)',
        mdeMenu_form1_2: 'Data collector',
        mdeMenu_form1_2: 'Data collector',
        mdeMenu_form1_3: 'Language',
        mdeMenu_form1_4: 'Documentation',
        mdeMenu_form1_5: 'Keywords',
        mdeMenu_form1_6: 'Data sharing',
        mdeMenu_form2: 'Survey Information',
        mdeMenu_form2_0: 'Data collection period',
        mdeMenu_form2_1: 'Dietary assessment method',
        mdeMenu_form2_2: 'Survey administration method',
        mdeMenu_form3: 'Sampling Information',
        mdeMenu_form4: 'Sampled Population Information',
        mdeMenu_form4_0: 'Population coverage',
        mdeMenu_form4_1: 'Age coverage',
        mdeMenu_form5: 'Data Analysis Information',
        mdeMenu_form5_0: 'Exclusion criteria',
        mdeMenu_form5_1: 'Missing values',
        mdeMenu_form5_2: 'Assessment of under-/over-reporting',
        mdeMenu_form5_3: 'Assessment of usual intake',
        mdeMenu_form5_4: 'Any other alteration from the original data',
        mdeMenu_form6: 'Food Consumption Information',
        mdeMenu_form6_0: 'Food coverage',
        mdeMenu_form6_1: 'Drinking water',
        mdeMenu_form6_2: 'Supplementation',
        mdeMenu_form6_3: 'Food list',
        mdeMenu_form6_4: 'Portion size estimation',
        mdeMenu_form6_5: 'Recipes and mixed dishes',
        mdeMenu_form6_6: 'Information on quantities',
        mdeMenu_form7: 'Food Composition Information',
        mdeMenu_form7_0: 'Food composition table',
        mdeMenu_form7_1: 'Macronutrients and dietary components',
        mdeMenu_form7_2: 'Micronutrients',
        mdeMenu_form8: 'Additional Information',
        mdeMenu_form8_0: 'Additional variables',
        mdeMenu_form8_1: 'Any additional information'
    }
});